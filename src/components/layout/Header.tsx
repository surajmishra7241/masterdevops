        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/">
            <motion.div
              ...
              className="text-2xl font-bold bg-gradient-to-r from-neon-pink via-neon-purple to-neon-blue bg-clip-text text-transparent"
            >
              Master DevOps
            </motion.div>
          </Link>
          ...
          <div className="hidden md:flex space-x-8">
            {navItems.map((item, index) => (
              ...
              >
                <Link
                  href={item.href}
                  className="relative text-gray-300 hover:text-neon-cyan transition-colors group"
                >
                  {item.name}
